package com.emsi.digital_bancking_backend;
...
import com.emsi.digital_bancking_backend.repositories.CustomerRepository;
...
public class digital_bancking_backendApplication {

    public static void main(String[] args) {
        SpringApplication.run(digital_bancking_backendApplication.class, args);
    }
    @Bean
